window.onload = function() {
    ...
    // вратарь
    const goalkeeper = {
        coords: [{ x: 390, y: 245 }, { x: 393, y: 245 },
            { x: 480, y: 245 }, { x: 480, y: 245 }],
        sizes: [{ width: 87, height: 117 }, { width: 84, height: 117 },
            { width: 85, height: 113 }, { width: 86, height: 113 }],
        scores: 0,
        // штрафные очки
        ...
        state: 0,
        draw() {
            ctx.drawImage(this.images[this.state], this.coords[this.state].x, this.coords[this.state].y,
